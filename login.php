              ...
              <br><br><br><br><br><br><div class="box featured">
                ...
                <form action="ceklogin.php" method="POST">
                  ...
                  <div class="form-group mt-3">
                    ...
                    <input type="text" class="form-control" name="no_karpas" id="no_karpas" placeholder="Masukkan nomor kartu pasien Anda" required>
                  </div><br>
                  <div class="btn-wrap">
                    <button type="submit" class="btn-buy" name="button">Masuk</button>
                    <!-- <a href="ceklogin.php" class="btn-buy">Masuk</a> -->
                  </div>
                  <div class="btn-wrap">
                    <a href="daftar.php" class="btn-buy-1">Belum punya akun ? Daftar Sekarang</a>
                  </div>
