...
<head>
  ...
  <title>Puskesmas Sidoarjo - Daftar Vaksin</title>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row mt-5">
          <div class="col-lg-12 mt-5 mt-lg-0">
            <form action="vaksin_confirm.php" method="post" role="form">
              ...
              <div class="form-group mt-3">
                <label for="date" class="mb-2">Pilih Tanggal Vaksin : </label>
                <input type="date" class="form-control" name="date" id="subject" required>
              </div>
              <div class="text-center mt-3"><button type="submit" class="btn-submit" id="submit">Daftar</button></div>
            </form>
          </div>
        </div>
